...
<html lang="en">
  ...
  <script>
    $.ajax({
                url: "<?php echo '../processData/getcount.php';//showstudentFees'); ?>",
                type: "GET",
                dataType: "json",
                success: function(response) {
                  if (response.userCount.status === 'success') {
                    const newUserCount = response.userCount.newUserCount;
                    const verifiedUserCount =response.userCount.verifiedUserCount;
                    const rejectedUserCount = response.userCount.rejectedUserCount;
                    $('#newUsers').html('<p>'+newUserCount+'</p>');
                    $('#verifiedUsers').html('<p>'+verifiedUserCount+'</p>');
                    $('#rejectedUsers').html('<p>'+rejectedUserCount+'</p>');
