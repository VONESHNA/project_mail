...
<html lang="en">
  ...
  <!--begin::App Wrapper-->
<?php include_once './admin/layout/usersidebar.php';?>
        <!--end::Sidebar Wrapper-->
      </aside>
      <!--end::Sidebar-->
      <!--begin::App Main-->
    ...
    <div class="container-fluid">
      <div class="row g-4">
        ...
        <div class="col-md-6">
         ...
         <input type="tel" class="form-control" id="mobNo" name="mobNo" placeholder="Enter your mobile number" maxlength="10" />
...
<p id="response" class="fs-2 text-center"></p>
...
<script>
        ...
        // Function to redirect after a few seconds
        function redirectToUrl() {
            setTimeout(function() {
                window.location.href = "<?php echo $redirect_url='./register.php'; ?>"; // Redirect to the specified URL
            }, 5000); // Change 5000 to the number of milliseconds you want to wait (5000ms = 5 seconds)
        }
...
$(document).ready(function() {
  ...
  $.ajax({
    ...
    data: new FormData(this),
      ...
      function redirectToUrl() {
          setTimeout(function() {
              window.location.href = "<?php echo $redirect_url='./user.php'; ?>"; // Redirect to the specified URL
          }, 5000); // Change 5000 to the number of milliseconds you want to wait (5000ms = 5 seconds)
      }
